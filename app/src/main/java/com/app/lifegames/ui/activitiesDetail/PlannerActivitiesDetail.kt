...
class PlannerActivitiesDetail : BaseFragment(), RatingBar.OnRatingBarChangeListener {
...
//                    it.data!!.image.let { activity?.let { it1 -> activtiy_img.loadImg(it!!, it1) } }
    ...
    private fun setValues(it: List<PlannerActivitiesTable>) {
    ...
    internal constructor(val context: Context, val mViewListModel: SelectedActivityViewModel, val userID: String, val id: String) : AsyncTask<Void, Void, List<PlannerActivitiesTable>>() {
