...
public class PreferenceClass {
    ...
    private static String PREFERENCE_NOTIFICATION="Notification";
    ...
    public static void setNotifyStringPreference(Context context, String name, String value) {
        appContext = context;
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_NOTIFICATION, 0);
        SharedPreferences.Editor editor = settings.edit();
        editor.putString(name, value);
        editor.commit();
    }
    ...
    public static String getStringNotifyPreferences(Context context, String name) {
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_NOTIFICATION, 0);
        return settings.getString(name, "");
    }
