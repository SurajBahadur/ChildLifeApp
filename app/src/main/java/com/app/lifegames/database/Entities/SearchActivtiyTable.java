...
@Entity
public class SearchActivtiyTable {
    ...
    public SearchActivtiyTable(String actID, String image, String title, String age_group, String age_group_icon, String overview, String time, String activity_details, String cat_icon, String cat_color, String cat_name, String cat_value, String materials, String warnings, String completed, String favourite, String ratings, String user_id) {
        this.id = id;
        this.actID = actID;
        this.image = image;
        this.title = title;
