...
public class ActivityDetailTable {
    ...
    public ActivityDetailTable(String actID, String image, String title, String age_group, String overview, String cat_color, String cat_name, String cat_value, String materials, String warnings, String time, String activity_details, String cat_icon, String ratings) {
        this.id = id;
        this.actID = actID;
        this.image = image;
        this.title = title;
