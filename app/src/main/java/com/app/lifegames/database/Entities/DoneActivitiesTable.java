...
@Entity
public class DoneActivitiesTable  {
    @PrimaryKey(autoGenerate = true)
    private int id;


    public DoneActivitiesTable(String actID, String image, String title, String age_group, String age_group_icon,
                               String overview, String cat_color, String cat_name, String cat_value, String time, String materials, String warnings,
                               String completed, String favourite, String activity_details, String cat_icon, String ratings, String user_id) {
        this.id = id;
        this.actID = actID;
        this.image = image;
        this.title = title;
