...
class ScheduleTimeAdapter (private val myDataset: List<String>?, val time: (String) -> Unit): RecyclerView.Adapter<ScheduleTimeAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
                                    viewType: Int): ScheduleTimeAdapter.MyViewHolder {
