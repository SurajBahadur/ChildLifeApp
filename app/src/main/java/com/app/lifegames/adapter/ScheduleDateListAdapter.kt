...
class ScheduleDateListAdapter (private val myDataset: List<ScheduleDatesTable>?, val date: (String) -> Unit, val updateValues: (String) -> Unit, val list: String): RecyclerView.Adapter<ScheduleDateListAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
                                    viewType: Int): ScheduleDateListAdapter.MyViewHolder {
