...
public class MaterialSpinner extends TextView {
  ...
  private void init(Context context, AttributeSet attrs) {
   ...
   /* defaultPaddingLeft = defaultPaddingRight =
    ...
    try {
      backgroundColor = ta.getResourceId(R.styleable.MaterialSpinner_ms_background_selector, R.drawable.book_type_button_back);
      ...
      hintColor = ta.getColor(R.styleable.MaterialSpinner_ms_hint_color, Color.parseColor("#FFFFFF"));
      arrowColor = ta.getColor(R.styleable.MaterialSpinner_ms_arrow_tint, Color.parseColor("#FFFFFF"));
      ...
      paddingTop = ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_padding_top, 0);
      paddingLeft = ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_padding_left, 25);
      paddingBottom = ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_padding_bottom, 0);
      paddingRight = ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_padding_right, 0);
      popupPaddingTop =
